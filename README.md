...
2. Откройте последний [релиз](https://github.com/HexaMar/HexaMar/releases/tag/v1.1.0)
3. Скачайте файл `CryptoMarInstaller.exe`
4. Следуйте инструкциям установщика.
5. Обновление (24.05.2025): Оптимизировано использование памяти. Теперь для быстрого поиска и экономии ресурсов используется фильтр Блума с проверкой баланса для предотвращения ложных срабатываний. Для создания файла фильтра запускайте программу от имени администратора.

### 🍎 Для macOS

1. Откройте последний [релиз](https://github.com/HexaMar/HexaMar/releases/tag/v1.1.0)
