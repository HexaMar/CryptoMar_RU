...
1. Откройте последний [релиз](https://github.com/HexaMar/CryptoMar_RU/releases/tag/v1.0.0)
...
Перед использованием ознакомтесь [Правила использования](https://github.com/HexaMar/CryptoMar_RU/blob/main/README.txt)
